    ...
    <div className="min-h-screen bg-[#080604] text-[#F5EFE0]">
      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        <header className="text-center mb-10">
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-[#B08D57] mb-4">
          ...
          <p className="mt-4 text-[#F5EFE0]/60 max-w-xl mx-auto">
            Build a junto of the voices you trust. Wake up to one short, AI-synthesized
            dispatch — the signal, not the noise.
          </p>
        </header>

        <div className="rounded-2xl overflow-hidden border border-[#F5EFE0]/10 bg-black shadow-2xl">
          <video
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href="/login"
            className="px-6 py-3 rounded-lg bg-[#B08D57] text-[#080604] font-600 font-mono text-sm uppercase tracking-wide hover:bg-[#c49d63] transition-colors"
          >
          ...
          <a
            ...
            download
            className="px-6 py-3 rounded-lg border border-[#F5EFE0]/20 text-[#F5EFE0]/80 font-mono text-sm uppercase tracking-wide hover:border-[#F5EFE0]/40 transition-colors"
          >
            Download video
          </a>
        </div>
