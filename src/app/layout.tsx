  ...
  return (
    <html lang="en" data-theme="dark" suppressHydrationWarning>
      <body className={`${spaceGrotesk.variable} ${oswald.variable} ${ibmPlexMono.variable}`}>
        ...
        <footer style={{ background: "rgb(var(--t-ink))", borderTop: "1px solid rgb(var(--t-brass) / 0.14)", padding: "16px", textAlign: "center" }}>
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "20px", marginBottom: "12px" }}>
            <a
              ...
              style={{ color: "rgb(var(--t-parchment) / 0.45)", display: "inline-flex", transition: "color 0.15s" }}
            >
          ...
          <p style={{ margin: 0, fontSize: "11px", lineHeight: 1.5, color: "rgb(var(--t-parchment) / 0.32)", maxWidth: "640px", marginLeft: "auto", marginRight: "auto" }}>
